...
*Last updated: Composite customization V1.2 accepted concept; V1.1 accepted progress; V1 accepted snapshot; Lunch Buffet 1–8 seed, API count, Python 3.13 venv note.*
